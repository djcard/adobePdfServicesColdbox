...
component {
	...
	// Module Properties
	this.title 				= "adobePdfGenerationServices";
	this.author 			= "";
	this.webURL 			= "";
	this.description 		= "";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	this.entryPoint			= "adobePdfGenerationServices";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "adobePdfGenerationServices";
	// CF Mapping
	this.cfmapping			= "adobePdfGenerationServices";
	// Auto-map models
